...
### Romanian-dubbed-only variant

For a strict Romanian-only scraper, add this manifest instead:

```
https://raw.githubusercontent.com/D3adlyRocket/All-in-One-Nuvio/refs/heads/main/manifest-romanian-dubbed.json
```

It rejects subtitle-only and unknown-language streams, and removes duplicate stream URLs.
